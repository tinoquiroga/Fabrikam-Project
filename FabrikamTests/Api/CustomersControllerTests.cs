...
public class CustomersControllerTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public async Task GetCustomer_WithValidId_ReturnsCustomer()
    {
        ...
        var allCustomersResponse = await _client.GetAsync("/api/customers");
    ...
    {
        // Act
        var response = await _client.GetAsync("/api/customers/analytics");
    ...
    {
        // Act
        var response = await _client.GetAsync($"/api/customers/analytics?region={Uri.EscapeDataString(region)}");
    ...
    public async Task GetCustomer_WithOrders_IncludesOrderData()
    {
        ...
        var customersResponse = await _client.GetAsync("/api/customers?includeOrders=true");
        ...
        // Act
        var response = await _client.GetAsync($"/api/customers/{customerId}?includeOrders=true");
    ...
    {
        // Act
        var response = await _client.GetAsync("/api/customers?region=InvalidRegion");
    ...
    {
        // Act
        var response = await _client.GetAsync("/api/customers/analytics?region=InvalidRegion");
