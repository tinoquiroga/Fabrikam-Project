...
public class ProductsControllerTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    {
        // Act
        var response = await _client.GetAsync("/api/products?inStock=true");
    ...
    {
        // Act
        var response = await _client.GetAsync("/api/products?category=InvalidCategory");
    ...
    {
        // Act
        var response = await _client.GetAsync("/api/products?category=SingleFamily&inStock=true&page=1&pageSize=10");
