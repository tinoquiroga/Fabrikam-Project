...
[Trait("Category", "Api")]
public class SupportTicketsControllerTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    {
        // Act
        var response = await _client.GetAsync("/api/supporttickets");
    ...
    public async Task GetSupportTicket_WithValidId_ReturnsTicket()
    {
        ...
        var allTicketsResponse = await _client.GetAsync("/api/supporttickets");
        ...
        // Act
        var response = await _client.GetAsync($"/api/supporttickets/{ticketId}");
    ...
    {
        // Act
        var response = await _client.GetAsync("/api/supporttickets/99999");
    ...
    {
        // Act
        var response = await _client.GetAsync($"/api/supporttickets?status={status}");
    ...
    {
        // Act
        var response = await _client.GetAsync($"/api/supporttickets?priority={priority}");
    ...
    public async Task PostSupportTicket_WithValidData_CreatesTicket()
    {
        ...
        // Act
        var response = await _client.PostAsync("/api/supporttickets", content);
    ...
    public async Task PutSupportTicket_WithValidData_UpdatesTicket()
    {
        ...
        // Act
        var response = await _client.PutAsync($"/api/supporttickets/{ticketId}", content);
    ...
    public async Task DeleteSupportTicket_WithValidId_DeletesTicket()
    {
        ...
        // Act
        var response = await _client.DeleteAsync($"/api/supporttickets/{ticketId}");
            ...
            response.StatusCode != System.Net.HttpStatusCode.NotImplemented)
        {
            ...
            var getResponse = await _client.GetAsync($"/api/supporttickets/{ticketId}");
    ...
    {
        // Act
        var response = await _client.GetAsync($"/api/supporttickets?page={page}&pageSize={pageSize}");
    ...
    {
        // Act
        var response = await _client.GetAsync("/api/supporttickets?status=Open&priority=High&page=1&pageSize=10");
    ...
    {
        // Act
        var response = await _client.GetAsync("/api/supporttickets?status=InvalidStatus");
    ...
    {
        // Act
        var response = await _client.GetAsync("/api/supporttickets?customerId=1");
    ...
    {
        // Act
        var response = await _client.GetAsync("/api/supporttickets?sortBy=priority&sortOrder=desc");
